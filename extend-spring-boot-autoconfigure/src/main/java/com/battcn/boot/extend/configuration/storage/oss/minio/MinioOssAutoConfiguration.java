package com.battcn.boot.extend.configuration.storage.oss.minio;

import com.battcn.boot.extend.configuration.storage.MinioStorageOperation;
import com.battcn.boot.extend.configuration.storage.domain.OssConstants;
import com.battcn.boot.extend.configuration.storage.properties.MinioStorageProperties;
...
import static com.battcn.boot.extend.configuration.storage.domain.OssConstants.ALI_YUN_STORAGE_OPERATION;
