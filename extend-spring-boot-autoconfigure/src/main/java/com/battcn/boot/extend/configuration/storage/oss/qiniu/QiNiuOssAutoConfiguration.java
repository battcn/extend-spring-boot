package com.battcn.boot.extend.configuration.storage.oss.qiniu;

import com.battcn.boot.extend.configuration.storage.QiNiuStorageOperation;
import com.battcn.boot.extend.configuration.storage.domain.OssConstants;
import com.battcn.boot.extend.configuration.storage.oss.qiniu.connection.QiNiuConnectionFactory;
import com.battcn.boot.extend.configuration.storage.oss.qiniu.connection.QiNiuOssClientConnectionFactory;
import com.battcn.boot.extend.configuration.storage.properties.QiNiuStorageProperties;
import org.springframework.boot.autoconfigure.condition.ConditionalOnProperty;
import org.springframework.boot.context.properties.EnableConfigurationProperties;
import org.springframework.context.annotation.Bean;

import static com.battcn.boot.extend.configuration.storage.domain.OssConstants.QI_NIU_STORAGE_OPERATION;
